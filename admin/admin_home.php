	...
	<nav class="navbar sticky-top navbar-light navbar-expand-lg" style="background-color: #747d8c;">
 		<a class="navbar-brand text-light" href="admin_home.php">CheckClassroom</a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
		    ...
		    <form name="search_form" method="post" action="admin_home_search.php">
								    ...
								    <div class="modal-content " style="box-shadow: 0px 0px 50px 25px #1e272e;">
								      ...
								      <div class="modal-body">
									     ...
									     <div class="form-group mb-4">
									     	...
									     	<input type="text" name="class_id" class="form-control" id="class_id<?=$row2['id']?>" value="<?=$row2['c_id']?>">
									     </div>
									     <div class="form-group mb-4">
									     	<label class="text-primary"> ชื่อรายวิชา : </label>
									     	<input type="text" name="class_name" class="form-control" id="class_name<?=$row2['id']?>" value="<?=$row2['c_name']?>">
									     </div> 
										...
										?> 
									     <div class="form-group mb-4">
									     	...
									     	<select class="form-control" name="class_year" id="class_year<?=$row2['id']?>">
									     		<option selected="" value="<?=$row2['c_year']?>"> <?=$row2['c_year']?> </option>
									     ...
									     <div class="form-group mb-4">
									     	...
									     	<select class="form-control" name="class_term" id="class_term<?=$row2['id']?>">
									     		<option selected="" value="<?=$row2['c_term']?>"> <?php if ($row2['c_term'] == 1) { ?>
									     			เทอมต้น
									     		<?php } elseif ($row2['c_term'] == 2) { ?>
									     			เทอมปลาย
									     		<?php } elseif ($row2['c_term'] == 3) { ?>
									      ...
									      <div class="form-group mb-4">
									     	...
									     	<select class="form-control" name="class_sec" id="class_sec<?=$row2['id']?>">
									     		<option selected="" value="<?=$row2['c_sec']?>"> <?=$row2['c_sec']?> </option>
								      ...
								      <div class="modal-footer">
								        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
								        <button type="submit" class="btn btn-primary" id="edit_class_submit<?=$row2['id']?>" name="edit_class_submit"> แก้ไขคลาส </button>
								      </div>
								    </div>
								  </div>
								</div>
